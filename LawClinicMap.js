...
import { withScriptjs, withGoogleMap, GoogleMap, Marker, InfoWindow} from "react-google-maps"
    ...
    export default class LawClinicMap extends Component {
      //constructor 
      constructor(props) {
        super(props)
        this.state = {
        ...
        this.LawClinicSuccess = this.LawClinicSuccess.bind(this);
    ...
    //didMount
    componentDidMount() {
        MapsApi.LawClinicGetAll(this.LawClinicSuccess, this.error);   
    };
    
    //success
    LawClinicSuccess(response) {
        this.setState({
            ...this.state,
